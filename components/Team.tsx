...
const team = [
  {
    name: "Ashley Parekh",
    role: "CEO & Co-founder",
    bio: "Former Silicon Valley Bank, Deutsche Bank",
    initials: "AP",
  },
  {
    name: "Ishaan Arora",
    role: "CTO & Co-founder",
    bio: "Former Techstars startup engineer",
    initials: "IA",
  },
];
...
export default function Team() {
  ...
  return (
    <section id="team" ref={ref} className="relative py-10 md:py-14">
      <div className="absolute inset-0 bg-gradient-to-b from-midnight via-deep-blue/30 to-midnight" />
      <div className="relative max-w-7xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }} className="text-center mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight">
            Built by
            <br />
            <span className="text-gradient-blue">Bankers</span>
          </h2>
        </motion.div>
        ...
        <div className="flex flex-wrap justify-center gap-6 max-w-2xl mx-auto">
          {team.map((member, i) => (
            <motion.div
              ...
              className="glass rounded-2xl p-7 md:p-9 text-center w-64 hover:border-accent-blue/20 transition-all duration-500"
            >
